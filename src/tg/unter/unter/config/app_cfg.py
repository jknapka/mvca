# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in unter.
...
base_config.model = unter.model
base_config.DBSession = unter.model.DBSession
